    ...
    <div className="max-w-2xl mx-auto">
      {isSuccess && (
        <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6 text-center">
          <p className="text-green-700 font-medium text-lg">ชำระเงินสำเร็จ!</p>
          <p className="text-green-600 text-sm mt-1">ขอบคุณสำหรับการสั่งซื้อ เราจะจัดส่งสินค้าให้เร็วที่สุด</p>
        </div>
      )}
